          ...
          <div class="col-md-3 d-none d-md-block">
            <div class="px-2 overflow-auto vh-100 py-2">
              ...
              <div class="list-group">
                ...
                ?>
                  <a href="?view=<?php echo urlencode($file); ?>" class="list-group-item list-group-item-action my-1 border-0 bg-body-tertiary rounded">
                    <h6 class="fw-medium text-truncate"><?php echo $file; ?></h6>
                    <small>Last modified: <?php echo $fileModifiedTime; ?></small>
                  </a>
                <?php } ?>
              </div>
            </div>
            ...
            <div class="px-2 overflow-auto vh-100 py-2">
              ...
              <div class="list-group">
                ...
                foreach ($files as $file) {
                  $fileModifiedTime = date("l, d F, Y", filemtime($file));
                ?>
                  <a href="?edit=<?php echo urlencode($file); ?>" class="list-group-item list-group-item-action my-1 border-0 bg-body-tertiary rounded">
                    <h6 class="fw-medium text-truncate"><?php echo $file; ?></h6>
                    <small>Last modified: <?php echo $fileModifiedTime; ?></small>
                  </a>
                <?php } ?>
      ...
      <div class="container mb-5">
        ...
        <div class="row row-cols-2 row-cols-md-4 g-1 mt-2">
          ...
          if (count($files) > 0) {
            ...
            foreach ($files as $file) {
              $fileModifiedTime = date("l, d F, Y", filemtime($file));
              $fileSize = filesize($file); // Get the file size in bytes
              ...
              <div class="col">
                <div class="card rounded-4 p-1 shadow border-0 h-100 bg-light-subtle">
                  <div class="card-body position-relative">
                    <h5 class="fw-medium text-center text-truncate"><?php echo $file; ?></h5>
                    ...
                    <div class="dropdown position-absolute top-0 end-0">
                      ...
                      <ul class="dropdown-menu rounded-4 shadow border-0">
                        ...
                        <li><a href="?view=<?php echo urlencode($file); ?>" class="dropdown-item"><i class="bi bi-eye-fill"></i> view</a></li>
                        <li><a href="?download=<?php echo urlencode($file); ?>" class="dropdown-item"><i class="bi bi-download"></i> download</a></li>
                        <li><a href="?edit=<?php echo urlencode($file); ?>" class="dropdown-item"><i class="bi bi-pencil-square"></i> edit</a></li>
